...
import com.nexstreaming.nexplayerengine.EGLSurfaceTexture.SecureMode;

import static com.nexstreaming.nexplayerengine.EGLSurfaceTexture.SECURE_MODE_NONE;
import static com.nexstreaming.nexplayerengine.EGLSurfaceTexture.SECURE_MODE_PROTECTED_PBUFFER;
import static com.nexstreaming.nexplayerengine.EGLSurfaceTexture.SECURE_MODE_SURFACELESS_CONTEXT;
import static com.nexstreaming.nexplayerengine.EGLSurfaceTexture.isProtectedContentExtensionSupported;
import static com.nexstreaming.nexplayerengine.EGLSurfaceTexture.isSurfacelessContextExtensionSupported;
...
public final class DummySurface extends Surface {
    ...
    private static int getSecureMode(Context context) {
        if (isProtectedContentExtensionSupported(context)) {
    ...
    private static class DummySurfaceThread extends HandlerThread implements Handler.Callback {
        ...
        private void initInternal(@SecureMode int secureMode) {
            if(eglSurfaceTexture == null) return;
